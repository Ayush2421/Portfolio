import Ayush_Portfolio from '../../assets/projects/Ayush_Portfolio.png';
...
{ name: 'Portfolio', image: Ayush_Portfolio, heading:"Portfolio", 
...
{ name: 'Roll_A_Dice', image: Roll_A_Dice, heading:"Roll A Dice", 
    text:"Pick a number and roll the dice by clicking it. If your chosen number matches the dice result, you earn points equal to that number; if it doesn’t match, you lose one point." },
];